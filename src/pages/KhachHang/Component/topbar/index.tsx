...
const Topbar: React.FC = () => {
    ...
    const { theme, toggleTheme, breadcrumbs, isSidebarOpen, setIsSidebarOpen, setPage } = useModel('KhachHang.GlobalState.index');
    const { currentUser } = useModel('KhachHang.Tài Khoản.thanghang');
    const { notifications, unreadCount, markAsRead, markAllAsRead } = useModel('KhachHang.Thông Báo.index');

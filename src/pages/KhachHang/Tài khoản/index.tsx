...
import accountBackground from '@/assets/KhachHang/Tài khoản/Backgroud.png';
import { getPageBackground } from '../Chế độ sáng tôi/themeBackground';
import useTaiKhoanModel from '@/models/KhachHang/Tài Khoản';
...
const TaiKhoan: React.FC = () => {
    const { currentUser: nguoiDungHienTai, updateProfile: capNhatHoSo, rankInfo: thongTinHang } = useModel('KhachHang.Tài Khoản.thanghang');
    const { theme: giaoDien } = useModel('KhachHang.GlobalState.index');

...
import {
  ...
  VAI_TRO_CONFIG,
} from '@/services/Quản Trị/Người Dùng';
import { IKhachHang } from '@/services/Quản Trị/Người Dùng/typing';
      ...
      render: (_, record) => (
        <div className={styles.colHoTen}>
          <Avatar
            ...
            style={{ background: record.mauNen }}
          >
            {record.vietTat}
          </Avatar>
          <div>
  ...
  return (
    <div className={styles.adminLayout}>
      ...
      <div className={styles.mainContent}>
        <Topbar
          title="Khách hàng"
          subtitle="Nhân viên công ty đặt món tại căng tin"
        />
          ...
          <div className={styles.tableSection}>
            <div className={styles.tableToolbar}>
              ...
              <div className={styles.toolbarRight}>
                <Button icon={<SlidersOutlined />} className={styles.btnFilter}>
                  Bộ lọc
                </Button>
                <Button
                  type="primary"
